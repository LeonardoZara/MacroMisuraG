...
Questo repository contiene la macro ROOT utilizzata per l'analisi dei dati dell'esperimento di Cavendish per la determinazione della costante di gravitazione universale $G$.
